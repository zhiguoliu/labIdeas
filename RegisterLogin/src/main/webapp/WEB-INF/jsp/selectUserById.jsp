...
<body>
	...
	<div class="container">
		<table class="table">
			...
			<s:iterator value="user.facilitySet">
				<tr>
		...
		<div class="row">
			<s:iterator value="facilitySet" status="st">
				...
				<div class="col-sm-6 col-md-4" style="text-align: justify; height: 450px; overflow: hidden;">
					...
					<div class="thumbnail">
						<a href=""><img src="/RegisterLogin/upload/<s:property value="picture" />"
							alt="通用的占位符缩略图"></a>
					</div>
					<div class="caption"  style="text-align: justify;">
						<h3>
							<s:if test="facilityName.length()<=20">
								<a href=""><s:property value="facilityName" /></a>
							</s:if>
							<s:else>
								<a href=""><s:property value="facilityName.substring(0,20)" />...	</a></s:else>
						</h3>
						<p>
							<a href=""><s:property value="introduction" /></a>
						</p>
