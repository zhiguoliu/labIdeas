	...
	<div class="container">
		<div>
			<button class="btn btn-primary" type="button"
				onclick="location.href='../facility/toAddFacility.action'">addFacility</button>
			<span> </span> <input type="button" value="addFacility"
				onclick="location.href='../facility/toAddFacility.action'" />
		</div>
	</div>
	<br>
			...
			<s:iterator value="facilityList">
				<tr>
					...
					<td><button type="button"
							onclick="location.href='toAddSchedule.action?facilityId=<s:property value="id" />'">addSchedule</button></td>
				</tr>
			</s:iterator>
		</table>
	</div>
		...
		<div class="row">
			<s:iterator value="facilityList">
				<div class="col-sm-6 col-md-4" style="text-align: justify; height: 450px; overflow: hidden;">
					...
					<div class="thumbnail">
						<a href="../facility/selectFacilityById.action?id=<s:property value="id" />"><img src="/RegisterLogin/upload/<s:property value="picture" />"
							alt="通用的占位符缩略图"></a>
					</div>
					<div class="caption">
						<h3>
